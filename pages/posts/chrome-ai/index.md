...
이 API를 사용하면 자체 AI 모델을 배포하거나 관리할 필요 없이 AI 기반 작업을 실행할 수 있습니다.

Google은 이러한 API가 모든 브라우저에서 작동하도록 표준화하기 위해 노력하고 있습니다.

## 장점

클라이언트 측 AI는 사용자의 브라우저에서 실행되고 사용자의 기기에서 추론을 실행합니다.

이를 통해 지연 시간 감소, 사용자 개인 정보 보호 강화, 오프라인 액세스 등의 이점을 누릴 수 있습니다.
